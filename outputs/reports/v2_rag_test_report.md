...
| 34 | 我的鞋子还没送到？ | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 35 | 我的鞋还没收到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 36 | 我的快递还没到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 37 | 物流一直不动 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 38 | 显示签收但我没收到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 39 | 我的鞋什么时候到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 40 | 怎么还没送到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 41 | 怎么还没收到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 42 | 我买的鞋还没发货 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 43 | 我的订单还没发货 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 44 | 快递一直不动 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 45 | 物流显示已签收但是我没收到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 46 | 我的订单什么时候到 | backend_required | — | — | — | false | 亲亲，这个需要查询您的订单/物流实时信息。目前系统暂时无法直接读取后台状态，建议转人工客服为您核实并处理哦。 | Pass | 用户本人物流状态请求正确拦截 |
| 47 | 发什么快递？ | pass_through | chat_qa | 物流发货 | 发什么快递？ | false | 亲亲 发的是申通 圆通 邮政 京东哈 这边目前不支持指定快递呢。 | Pass | 通用发货政策保持普通 RAG 路径 |
| 48 | 一般多久发货？ | pass_through | chat_qa | 物流发货 | 一般多久发货 | false | 您好！我们这边一般是24小时内发货的哦，不出意外的话都是当天17点之前的订单是当天安排发货的呢！特殊情况是48小时之内发货哦的呢。一般是先拍下先发货的，按照顺… | Pass | 通用发货政策保持普通 RAG 路径 |
| 49 | 默认发圆通吗？ | pass_through | chat_qa | 物流发货 | 你们寄的是圆通．． | false | 本店！请问有什么可以帮助您？。这款鞋子是标准尺码的哦，按照平常穿着拍下哈。亲亲，脚宽脚胖建议拍大一码哦。 | Pass | 通用发货政策保持普通 RAG 路径 |
| 50 | 偏远地区能发吗？ | pass_through | chat_qa | 尺码问题 | 有远费险嘛？ | false | 有运费险的呢。标准尺码，建议您按日常穿着尺码选择哈。宝贝 您早点下单呢 下单后这边安排仓库优先给您发货呢。 | Pass | 通用发货政策保持普通 RAG 路径 |
