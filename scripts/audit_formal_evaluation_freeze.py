...
for name in ("evaluation/formal_qa_only_baseline_spec.json","evaluation/formal_rq1_scoring_schema.json","evaluation/formal_rq2_boundary_cases.json","evaluation/formal_rq3_multiturn_cases.json","data/external_eval/review/final/external_store_v1_gold_51.csv"):
